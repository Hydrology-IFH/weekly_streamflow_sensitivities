...
path_p <- "/Users/mweiler/Markus/Research Projects/KHR/CH_climate/KHR-1/PPsum_24h_aktualisiert/data/"	
path_t <- "/Users/mweiler/Markus/Research Projects/KHR/CH_climate/KHR-1/temp_mean_aktualisiert/data_temp/"

path_q <- "/Users/mweiler/Markus/Research Projects/KHR/Abflussdaten/BAFU Daten/BAFUvergletscherte/"
...
if (length(good) > 15) {
	Q <- aw$Q[good]
	T <- aw$T[good]
	inp <- aw$P[good]     # precip oder schnee
